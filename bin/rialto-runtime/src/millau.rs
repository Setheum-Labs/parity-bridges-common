...
impl Decode for FromMillauMessagePayload {
	fn decode<I: Input>(input: &mut I) -> Result<Self, codec::Error> {
		...
		// TODO
		// if !input.is_empty() {
		// 	return Err("Input buffer has still data left after decoding!".into());
		// }
...
impl TargetHeaderChain<ToMillauMessagePayload, bp_rialto::AccountId> for Millau {
	...
	type MessagesDeliveryProof = (bp_millau::Hash, StorageProof);
	...
	fn verify_messages_delivery_proof(
		...
		unimplemented!("TODO: call bridge function")
	}
}
...
impl SourceHeaderChain<bp_millau::Balance> for Millau {
	type Error = &'static str;
	type MessagesProof = (bp_millau::Hash, StorageProof);
